...
import (
	...
	testv1 "github.com/N0Cloud/codegen-template/api/test/v1"
	...
	v1 "github.com/N0Cloud/codegen-template/client/listers/test/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.TestV1().Foos(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TestV1().Foos(namespace).Watch(options)
			},
		},
		&testv1.Foo{},
		resyncPeriod,
...
func (f *fooInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&testv1.Foo{}, f.defaultInformer)
}
