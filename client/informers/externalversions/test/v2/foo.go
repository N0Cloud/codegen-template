...
import (
	...
	testv2 "github.com/N0Cloud/codegen-template/api/test/v2"
	versioned "github.com/N0Cloud/codegen-template/client/clientset/versioned"
	internalinterfaces "github.com/N0Cloud/codegen-template/client/informers/externalversions/internalinterfaces"
	v2 "github.com/N0Cloud/codegen-template/client/listers/test/v2"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.TestV2().Foos(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TestV2().Foos(namespace).Watch(options)
			},
		},
		&testv2.Foo{},
		resyncPeriod,
...
func (f *fooInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&testv2.Foo{}, f.defaultInformer)
}
